...
public class D_MenuAdapter extends BaseAdapter {

	private Context context;

	public D_MenuAdapter(Context context) {
	...
	private Integer[] images = { R.drawable.menu_index, R.drawable.menu_pack,
			R.drawable.menu_customer2, R.drawable.menu_about

	};

	private Integer[] texts = { R.string.menu_index, R.string.menu_receivepkg,
